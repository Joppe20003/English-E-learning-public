    ...
    <div class="row">
        <form method="post" action="register.php">
            <div class="p-5 bg-white rounded shadow-sm">
                ...
                <button type="submit" class="btn btn-primary w-100" name="nextStep" onclick="checkDubbleExpression(password.value,repeatPassword.value)">Volgende</button>
            </div>
        </form>
    </div>
</div>
...
<footer>
    <div class="bg-white pt-1 pb-1 mt-1 d-flex justify-content-center">
        Copyright: © Alle rechten voor behouden 2023 - <script>document.write(new Date().getFullYear())</script>
    </div>
</footer>
</html>
<?php
